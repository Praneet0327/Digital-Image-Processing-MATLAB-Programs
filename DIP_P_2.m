...
% l=im2double(imread('/Users/praneet/Desktop/ADGIPS/Sem VI/Labs/DIP_Lab/P-2/Blue Wormhole.jpg')); 
% f1=fft(l); 
% f2=fftshift(f1); 
...
im = imread('/Users/praneet/Desktop/ADGIPS/Sem VI/Labs/DIP_Lab/P-2/Blue Wormhole.jpg');
im = rgb2gray(im); 
